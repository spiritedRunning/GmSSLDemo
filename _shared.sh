...
ANDROID_NDK=/mnt/e/Android/android-ndk-r21b
TOOLS_ROOT=`pwd`/GmSSL-master
#这里使用的 ndk是r21d r21d 不具备 mips 和mips64
ARCHS=("android-armeabi" "android64-aarch64")
# "android"  "android-mips" "android-mips64"  "android-x86" "android64"
ABIS=("armeabi-v7a" "arm64-v8a" )
# "armeabi"  "mips" "mips64" "x86" "x86_64"

# Default to API 21 for it is the minimum requirement for 64 bit archs.
# 编译64位需要使用21或以上Android-Api
